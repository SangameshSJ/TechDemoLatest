...
#         network.get("app_target_group")  # Pass target group if it exists
#     )
...
#         key_name,
#         network.get("app_lb")  # Pass load balancer if it exists
#     )
...
def main():
    ...
    # Create compute resources with optional target group
    compute_resources = create_compute_resources(
        network, 
        security_groups, 
        iam_resources["instance_profile"], 
